...
void WriteData(string const& ins, int const& repeticion)
{
    // Tiempo
    ...
    */
    ...
    writer << "Utilizacion " << to_string(incumbente.utilizacion) << " VolCajasEmpacado " << to_string(incumbente.volEmpacado) << " Duracion[s] " << to_string(duracion) << " Iteraciones " << holi << endl;
    int id = 0;
